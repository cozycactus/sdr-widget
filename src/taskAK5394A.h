...
#define IS_SILENT		0x00030000 >> 8 // Comment is void: Approximately: compare (si_score_high + abs(sample_L >> 8) + abs(sample_R) >> 8) to 4 LSBs at 16-bit audio, 1024 LSBs at 24-bit audio
