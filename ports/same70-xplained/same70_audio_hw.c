...
void same70_audio_hw_get_status(same70_audio_hw_status_t *status)
{
	...
	status->candidate_pins = "TD=PD26/J502.1 RD=PA10/J504.2 RF=PD24/J504.1 RK=PA22/J504.3 TK=PB1/J505.8 TF=PB0/J505.7 MCLK=external_to_codecs AD1856=mono_DATA_TD_CLK_TK_LE_TF formatter_owns_ad1856_data_clk_le";
	status->candidate_headers = "J502,J504,J505,J507,EXT1";
	status->clock_plan = "external_low_jitter_formatter_owns_ad1856_data_clk_le_slave_ssc_explicit_fb_tbd";
	...
	status->required_signals = "ext_mclk_to_codecs,bclk_to_rk_tk,lrck_to_rf_tf,adc_sdata,td_to_formatter,formatter_to_ad1856_data_clk_le,ad1856_bipolar_supply,codec_reset,adc_control";
	...
	status->next_step = "ad1856_formatter_clock_only_probe_then_slave_ssc_tx_gate";
}
