...
void same70_audio_hw_get_status(same70_audio_hw_status_t *status)
{
	...
	status->next_step = "cs4272_control_port_status_only_then_twi0_skeleton_and_usb_descriptor_matrix";
}
