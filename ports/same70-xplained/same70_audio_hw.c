...
void same70_audio_hw_get_status(same70_audio_hw_status_t *status)
{
	...
	status->candidate_pins = "CS4272=I2S_TD_RD_BCLK_LRCK TD=PD26/J502.1 RD=PA10/J504.2 RF=PD24/J504.1 RK=PA22/J504.3 TK=PB1/J505.8 TF=PB0/J505.7 MCLK=external_to_codecs xo_44_en=not_wired xo_48_en=not_wired AD1856=mono_DATA_TD_CLK_TK_LE_TF formatter_owns_ad1856_data_clk_le";
	status->candidate_headers = "J502,J504,J505,J507,EXT1";
	status->clock_plan = "cs4272_master_256fs_divides_mclk_to_bclk_lrck_same70_slave_ssc_explicit_fb_external_low_jitter_xo_select_from_usb_rate_ad1856_formatter_alt";
	status->sample_frame = "selected_family=from_usb_rate 44k16_mclk=11289600_bclk=2822400_xo=xo_44_en_feedback_44k1=0x00058333 48k24_mclk=12288000_bclk=3072000_xo=xo_48_en_feedback_48k=0x00060000";
	...
	status->required_signals = "cs4272_mclk_11m2896_or_12m288,xo_44_en_gpio_tbd,xo_48_en_gpio_tbd,bclk_to_rk_tk,lrck_to_rf_tf,dac_sdata_td,adc_sdata_rd,codec_reset,codec_control,td_to_formatter,formatter_to_ad1856_data_clk_le,ad1856_bipolar_supply";
	...
	status->next_step = "cs4272_xo_select_status_only_then_gpio_pin_choice_then_clock_only_probe_external_bclk_lrck_slave_ssc_gate";
}
