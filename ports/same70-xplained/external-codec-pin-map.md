...
This is the future wiring map for an external original-style SDR Widget audio
...
The preferred target is the original SDR Widget-style AK5394A/CS4344 class of
hardware, not a generic USB/I2S audio module. The current SAME70 board can prove
USB timing, generated audio, and bit-perfect loopback, but it cannot prove
analog SDR input or output without external ADC/DAC hardware.
...
| --- | --- | --- | --- | --- | --- | --- |
| DAC serial data | PD26 | J502 pin 1 | AD0 | TD | Analog-low Arduino header | J502 is not populated by default; no 0-ohm change noted for pin 1 |
| ADC serial data | PA10 | J504 pin 2 | AD9 | RD | Analog-high Arduino header | J504 is not populated by default |
| ADC frame sync / LRCK candidate | PD24 | J504 pin 1 | AD8 | RF | Analog-high Arduino header | J504 is not populated by default |
| ADC bit clock candidate | PA22 | J504 pin 3 | AD10 | RK | Analog-high Arduino header | J504 is not populated by default |
| DAC bit clock candidate | PB1 | J505 pin 8 or J507 pin 4 | D14 or D23 | TK | Shared with TXD0 on J505 and D23 on J507 | J505/J507 are not populated by default |
| DAC frame sync / LRCK candidate | PB0 | J505 pin 7 or J507 pin 5 | D15 or D24 | TF | Shared with RXD0 on J505 and D24 on J507 | J505/J507 are not populated by default |
| Master clock candidate | PB13 | J504 pin 5 or J507 pin 19 | DAC0 or D38 | PCK0 | Also DAC0/SCK0 depending on mux | J504/J507 are not populated by default |
| Codec reset / GPIO default | PC17 | EXT1 pin 10 | SPI_SS_B/GPIO | GPIO | Xplained Pro extension header | EXT1 has populated extension-header footprint; verify actual header population |
